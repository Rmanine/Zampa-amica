...
VALUES 
    ('Lucky','en','Cane',36,'Maschio','Medio','Lucky è un''esplosione di energia con un bellissimo mantello bianco e nero. Ha uno sguardo intelligente e vive per giocare: se hai una pallina da lanciargli, sarai il suo migliore amico per sempre. Cerca un compagno che ami le avventure all''aria aperta.','1.jpg'),
    ('Thor','it','Cane',60,'Maschio','Grande', 'Non lasciarti ingannare dal suo aspetto fiero: Thor è in realtà un gigante dal cuore dolce. Ha un portamento nobile e attento, ma appena varca la soglia di casa si trasforma in un cucciolone che cerca solo carezze e un posto morbido dove accucciarsi vicino a te.','2.jpg'),
    ('Felix','en','Gatto',48,'Maschio',NULL,'Con la sua elegante livrea bianca e nera, Felix sembra indossare perennemente uno smoking. È un gatto di grande classe, tranquillo e osservatore. Adora posizionarsi nei punti strategici della casa per controllare il suo regno, ma non rifiuta mai una sessione di grattini dietro le orecchie.','3.jpg'),
    ('Brusco','it','Cane',72,'Maschio','Grande','Brusco è un simpaticissimo Bulldog dall''espressione imbronciata che nasconde un carattere d''oro. La vita atletica non fa per lui: è un professionista del relax, campione olimpico di pisolini sul divano e grande amante del buon cibo. Il compagno perfetto per serate film e coccole.','4.jpg'),
    ...
    ('Gizmo','it','Cane',24,'Maschio','Grande','Impossibile non sorridere guardando Gizmo! Con quelle orecchie enormi che sembrano captare ogni segnale e il suo sguardo vispo, è un concentrato di simpatia. È un cagnolino da compagnia eccezionale, sempre pronto a strapparti un sorriso con le sue buffe espressioni.','10.jpg'),
    ('Lassie','en','Cane',6,'Femmina','Piccolo','Un batuffolo di pelo tricolore con occhi che brillano di intelligenza. Questa cucciola è dolcissima, impara alla velocità della luce ed è ansiosa di compiacere. È in quella fase meravigliosa in cui tutto è una scoperta: ha bisogno di una guida affettuosa per diventare una splendida adulta.','11.jpg'),
    ('Birba','it','Gatto',8,'Maschio',NULL,'Il nome dice tutto: Birba è un uragano di allegria. Per lui la vita è un gioco continuo, che si tratti di inseguire un filo d''erba o fare agguati amichevoli alle tue caviglie. Se cerchi un gattino che porti vita, risate e un pizzico di caos felice in casa, lui è quello giusto.','12.jpg'),
    ...
    ('Iggy','en','Cane',24,'Maschio','Piccolo','Compatto, muscoloso e con una faccia da fumetto, Iggy è un Boston Terrier pieno di gioia di vivere. È un cane socievole che va d''accordo con tutti e adora giocare e stare in compagnia. Impossibile sentirsi soli con lui nei paraggi.','17.jpg'),
