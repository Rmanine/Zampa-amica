...
VALUES 
    ...
    ('Lilli','it','Cane',156,'Femmina',"Piccolo",'Lilli è una cagnolina maltese a cui ci si affeziona subito. Compagna ideale per coccole, pomeriggi sul divano e lunghe sessioni di studio; amica perfetta per tenerti al calduccio e tirarti su il morale. Nonostante la sua età è molto attiva: le piace giocare e saltare su e giù dal divano.','20.jpeg'),
    ('Briscola','it','Gatto',61,'Femmina',NULL,'Briscola (o Briscolina, decidete voi) è il gatto perfetto per coloro che amano dormire tutto il giorno: è impossibile svegliarla! Briscola è un gatto molto calmo e pacifico, l''importante è non dimenticarsi il suo cibo preferito: le crocchette al formaggio!.','21.jpeg'),
    ('Mia','it','Gatto',8,'Femmina',NULL,'Mia non è per i deboli: è un gatto super attivo e giocoso, ma nel momento del bisogno sa essere anche il gatto più dolce del mondo. Mia è il gatto ideale se si cerca un compagno non solo di gioco, ma di vita.','22.jpeg'),
    ('Paciock','it','Cane',109,'Maschio','Piccolo','Neville Paciock, detto Paciockino, prende il nome dall''omonimo personaggio della saga di <span lang="en">Harry Potter</span>. E proprio come lui è tanto timido quanto coraggioso. Prova di amore e affetto incondizionati (provare per credere).','23.jpg');
